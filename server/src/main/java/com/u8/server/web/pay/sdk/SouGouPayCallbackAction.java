...
public class SouGouPayCallbackAction extends UActionSupport {
    ...
    public void payCallback(){
        try{
            ...
            if(order.getMoney() > realMoney){
                ...
                this.renderState(false, "金额不一致");
                return;

            }

            if(isValid(channel.getCpPayID())){
    ...
    public boolean isValid(String key) throws UnsupportedEncodingException {

        StringBuilder sb = new StringBuilder();
        sb.append("amount1=").append(URLEncoder.encode(amount1, "UTF-8"))
                .append("&amount2=").append(URLEncoder.encode(amount2, "UTF-8"))
                .append("&appdata=").append(URLEncoder.encode(appdata, "UTF-8"))
                .append("&date=").append(URLEncoder.encode(date, "UTF-8"))
                .append("&gid=").append(URLEncoder.encode(gid, "UTF-8"))
                .append("&oid=").append(URLEncoder.encode(oid, "UTF-8"))
                .append("&realAmount=").append(URLEncoder.encode(realAmount, "UTF-8"))
                .append("&role=").append(URLEncoder.encode(role, "UTF-8"))
                .append("&sid=").append(URLEncoder.encode(sid, "UTF-8"))
                .append("&time=").append(URLEncoder.encode(time, "UTF-8"))
                .append("&uid=").append(URLEncoder.encode(uid, "UTF-8"))
                .append("&" + key);

        Log.d("sougou sign str : local:%s", sb.toString());
...
//
//        SouGouPayCallbackAction a = new SouGouPayCallbackAction();
//        a.amount1 = "1";
//        a.amount2 = "100";
//        a.appdata = "1297924436657176576";
//        a.date = "170801";
//        a.gid = "15135";
//        a.oid = "P170801_19696795";
//        a.realAmount = "1";
//        a.role = "";
//        a.sid = "1";
//        a.time = "20170801183749";
//        a.uid = "76015654";
//        a.auth = "441ac340f224f82e8549904678ddea52";
//
//        boolean valid = a.isValid("{240ACD3F-3B42-4B3C-8092-28140C609A6B}");
//
