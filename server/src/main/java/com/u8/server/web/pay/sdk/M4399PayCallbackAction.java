...
public class M4399PayCallbackAction extends UActionSupport{
    ...
    private String coupon_mark;         // 	优惠券的唯一标识
    private String coupon_money;        //  优惠券的金额
    ...
    public void payCallback(){
        try{
            ...
            int moneyInt = ((Float)(100f * Float.valueOf(money))).intValue();
    ...
    private boolean isValid(UChannel channel) throws Exception {
        ...
        if(!TextUtils.isEmpty(coupon_mark)){
            sb.append(coupon_mark);
        }
        ...
        Log.i("the 4399 valid str :: "+sb.toString());
        Log.i("The 4399 sign is "+sign+"; the vCode is "+vCode);
    ...
    public String getCoupon_mark() {
        return coupon_mark;
    }

    public void setCoupon_mark(String coupon_mark) {
        this.coupon_mark = coupon_mark;
    }
