...
<div id="dialog_add" class="easyui-dialog u8_form"
    ...
    <form id="fm" method="post" novalidate>
        ...
        <div class="u8_form_row">
            <label>用户名：</label>
            <input id="username" type="text" class="easyui-textbox" style="height: 25px;" name="username"
                   maxlength="255" required="false"/>
        </div>

        <div class="u8_form_row">
            <label>密 码：</label>
            <input id="password" type="password" class="easyui-textbox" placeholder="密码(字母和数字,8-20位)"
                   style="height: 25px;" name="password" maxlength="20" required="false"/>
        </div>
