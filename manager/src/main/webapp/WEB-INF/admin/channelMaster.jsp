...
<div id="dialog_add" class="easyui-dialog u8_form"
    ...
    <form id="fm" method="post" novalidate>
        ...
        <div class="u8_form_row">
            <label>渠道商名称：</label>
            <input type="text" class="easyui-textbox" style="height: 25px;" name="masterName" maxlength="255"
                   required="false"/>
        </div>

        <div class="u8_form_row">
            <label>SDK名称：</label>
            <input type="text" class="easyui-textbox" style="height: 25px;" name="sdkName" maxlength="255"
                   required="false"/>
        </div>
        <div class="u8_form_row">
            <label>用户名后缀：</label>
            <input type="text" class="easyui-textbox" style="height: 25px;" name="nameSuffix" maxlength="255"
                   required="false"/>
        </div>

        <div class="u8_form_row">
            <label>登录认证URL：</label>
            <input type="text" class="easyui-textbox" style="height: 25px;" name="authUrl" maxlength="1024"
                   required="false"/>
        </div>

        <div class="u8_form_row">
            <label>支付回调URL：</label>
            <input type="text" class="easyui-textbox" style="height: 25px;" name="payCallbackUrl" maxlength="1024"
                   required="false"/>
        </div>

        <div class="u8_form_row">
            <label>渠道下单URL：</label>
            <input type="text" class="easyui-textbox" style="height: 25px;" name="orderUrl" maxlength="1024"
                   novalidate/>
        </div>

        <div class="u8_form_row">
            <label>脚本类：</label>
            <input type="text" class="easyui-textbox" style="height: 25px;" name="verifyClass" maxlength="1024"
                   required="false"/>
        </div>
    </form>
</div>
