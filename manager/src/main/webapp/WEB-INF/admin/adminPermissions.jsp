...
<div id="dialog_add" class="easyui-dialog u8_form"
    ...
    <form id="fm" method="post" novalidate>
        ...
        <div class="u8_form_row">
            <label>功能名称：</label>
            <input id="name" type="text" class="easyui-textbox" style="height: 25px;" name="name" maxlength="255"
                   required="false"/>
        </div>

        <div class="u8_form_row">
            <label>父功能：</label>
            <input id="parents" type="text" class="easyui-combobox" style="height: 25px;" name="parents"
                   maxlength="255"/>
        </div>
...
<div id="dialog_add_role" class="easyui-dialog u8_form"
    ...
    <form id="fm_role" method="post" novalidate>
        ...
        <div class="u8_form_row">
            <label>角色名称：</label>
            <input id="roleName" type="text" class="easyui-textbox" style="height: 25px;" name="roleName"
        ...
        <div class="u8_form_row">
            <label>角色描述：</label>
            <input id="roleDesc" type="text" class="easyui-textbox" style="height: 25px;" name="roleDesc"
                   maxlength="255"/>
        </div>
...
<div id="dlg-buttons_role">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="javascript:$('#dialog_add_role').dialog('close')"
       style="width:90px">取 消</a>
</div>
...
//      }
    ...
    function onSysMenuChanged(currID) {
        ...
        $.post('<%=basePath%>/admin/updateRolePermission', {
            adminRoleID: adminRoleID,
            rolePermission: idLst
        }, function (result) {
            if (result.state == 1) {
                reload();
            } else {
